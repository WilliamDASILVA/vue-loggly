...
VueLoggly.install = function (Vue, opts) {
  ...
  _loggly.tracker.push(options);

  Vue.prototype.$loggly = function (tracking) {
    if (tracking) {
      _loggly.tracker.push(tracking);
    }
  };
};
...
},{"./loggly":29}],29:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.LogglyTracker = undefined;
...
var CONSTANTS = {
  ...
  LOGGLY_SESSION_KEY_LENGTH: undefined.LOGGLY_SESSION_KEY.length + 1,
...
var LogglyTracker = exports.LogglyTracker = function () {
  function LogglyTracker() {
  ...
  _createClass(LogglyTracker, [{
    ...
    value: function track(data) {
      ...
      _axios2.default.post(this.inputUrl, data).catch(function (err) {
...
},{"./misc":30,"axios":1}],30:[function(require,module,exports){
'use strict';
